...
from tcrabpairing.serializers import tcrabpairingSerializer
...
class tcrabpairingView(APIView):
    ...
    queryset = tcrabpairing.objects.all().order_by('id')
    serializer_class = tcrabpairingSerializer
    ...
    def get(self, request):
        ...
        serializer = tcrabpairingSerializer(result_page, many=True)
