...
def add_data():
    ...
    with open('/home/platform/phage_db/phage_api/workspace/rawd_data/Virulent_factor_Antimicrobial_resistance_gene_V2/all_phage_result/all_virulent_factor_results.tsv', 'r') as f:
        lines = f.readlines()

    for line in lines:
        l = line.strip().split("\t")
        phage_virulent_factor.objects.create(
            Protein_id=l[0], Aligned_Protein_in_VFDB=l[1], Phage_Acession_ID=l[2], dataset=l[3])
