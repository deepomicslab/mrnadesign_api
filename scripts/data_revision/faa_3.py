...
fatsapath='/home/platform/phage_db/phage_api/workspace/data_revision/protein/03.IMG_VR/gene.faa'
...
with open(fatsapath, 'r') as fasfile:
    for record in SeqIO.parse(fasfile, 'fasta'):
        ...
        with open('/home/platform/phage_db/phage_data/data/phage_sequence/phage_faa/IMG_VR/'+phageid+'.faa','a') as f:
                    f.write('>'+record.id+'\n')
                    seq=str(record.seq)
                    while len(seq) > 70:
                        f.write(seq[:70] + "\n")
