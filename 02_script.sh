...
do
    ...
    /home/platform/.conda/envs/mrnadesign/bin/python /home/platform/project/mrnadesign_platform/mrnadesign_api/manage.py crontab run d6685bd8341b65d4546e7a8bf51a927b
    echo run contab
    sleep 1m
done